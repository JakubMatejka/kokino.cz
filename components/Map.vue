<template>
  <div>
    ...
    <div id="mapkit-7132"></div>
  </div>
</template>

<script src="//maps.googleapis.com/maps/api/js?key=x&extension=.js"></script>
...
<script>
    ...
    function init() {
        ...
        zoom: 3,gestureHandling: 'auto',fullscreenControl: false,zoomControl: true,
        ...
        var mapElement = document.getElementById('mapkit-7132');
