...
<style>
  ...
  body {
    ...
    background: url('/images/bg-kavarny.png') no-repeat 3rem 45.1%;
  }
  section {
    margin: 0 0 2.5rem;
  }
  h2 {
    ...
    font: 700 2.3em 'Playfair Display', serif;
  }
  h3 {
  ...
  .historie {
    background: url('/images/bg-historie.png') no-repeat 5% 63%;
  }
  .historie-obrazky {
    margin: 0 -1rem;
  }
